...
namespace DadJokeGenerator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => c.SwaggerDoc("v1", new OpenApiInfo{Title = "Dad Joke Generator Api", Version = "v1"}));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Dad Joke Generator Api");
